...
#define RTMP_SIG_SRS_SERVER RTMP_SIG_SRS_KEY "/" RTMP_SIG_SRS_VERSION "(" RTMP_SIG_SRS_CODE ")" "(Camerite DEV-" SRS_XSTR(CAMERITE_VERSION) "." SRS_XSTR(CAMERITE_VERSION_REVISION) ")"
